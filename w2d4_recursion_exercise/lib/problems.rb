...
def lucas_number(n)
  ...
  return res = lucas_number(n - 1) + lucas_number(n - 2)
end
...
def sum_array(array)
  ...
  return sum = first_ele + sum_array(rest_ele)
end
...
def reverse_string(str)
  ...
  first_char = str[0]
  rest_char = str[1..-1]
  return res = reverse_string(rest_char) + first_char
end
